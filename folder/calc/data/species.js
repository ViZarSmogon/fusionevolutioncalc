...
var PLA_PATCH = {
    ...
    Sneasel: { otherFormes: ['Sneasel-Hisui', 'Sneasel-Prime'] },
    Stantler: { nfe: true },
...
var SV_PATCH = {
    ...
    Primeleo: {
        types: ['Fighting', 'Steel'],
        bs: { hp: 101, at: 125, df: 83, sa: 86, sd: 79, sp: 96 },
        weightkg: 131,
    ...
    'Samuraiai-Hisui': {
        types: ['Water', 'Poison'],
        bs: { hp: 76, at: 121, df: 77, sa: 90, sd: 68, sp: 97 },
        weightkg: 42.7,
    ...
    'Tapu Titan': {
        types: ['Fairy', 'Ice'],
        bs: { hp: 130, at: 131, df: 90, sa: 65, sd: 75, sp: 74 },
        weightkg: 372.8,
    ...
    'Scream Cormorant': {
        ...
        otherFormes: ['Scream Cormorant-Gorging', 'Scream Cormorant-Gulping']
    },
    'Scream Cormorant-Gorging': {
        types: ['Water', 'Fairy'],
        bs: { hp: 95, at: 75, df: 79, sa: 75, sd: 105, sp: 111 },
        weightkg: 13,
        abilities: { 0: 'Prehistoric Hunter' },
    ...
    Okiferro: {
        types: ['Grass', 'Fighting'],
        bs: { hp: 85, at: 115, df: 125, sa: 60, sd: 105, sp: 50 },
        weightkg: 101,
    ...
    Dragocoal: {
        types: ['Fire', 'Dragon'],
        bs: { hp: 100, at: 120, df: 110, sa: 90, sd: 95, sp: 55 },
        weightkg: 260.3,
    ...
    Icekrai: {
        types: ['Dark', 'Ice'],
        bs: { hp: 75, at: 70, df: 95, sa: 120, sd: 145, sp: 90 },
        weightkg: 112.8,
    ...
    'Iron Matcha': {
        types: ['Grass', 'Poison'],
        bs: { hp: 80, at: 66, df: 90, sa: 130, sd: 100, sp: 90 },
        weightkg: 19.1,
    ...
    Anoraidon: {
        types: ['Fighting', 'Bug'],
        bs: { hp: 75, at: 115, df: 85, sa: 65, sd: 75, sp: 105 },
        weightkg: 157.7,
        abilities: { 0: 'Mercury Pulse' }
    },
    'Aero Wake': {
        types: ['Water', 'Flying'],
        bs: { hp: 89, at: 95, df: 79, sa: 103, sd: 79, sp: 121 },
        weightkg: 169.5,
    ...
    'Aero Wake-Mega': {
        types: ['Water', 'Flying'],
        bs: { hp: 89, at: 125, df: 99, sa: 113, sd: 99, sp: 141 },
        weightkg: 189.5,
        abilities: { 0: 'Tough Claws' },
    ...
    'Lelecuno-Galar': {
        gender: 'N',
        types: ['Psychic'],
        bs: { hp: 80, at: 85, df: 85, sa: 127, sd: 107, sp: 99 },
        abilities: { 0: 'Mind Domain' },
        weightkg: 34.7
    },
    Farinape: {
        types: ['Psychic', 'Fighting'],
        bs: { hp: 100, at: 100, df: 70, sa: 110, sd: 70, sp: 95 },
    ...
    'Sneasel-Prime': {
        types: ['Poison', 'Ice'],
        bs: { hp: 60, at: 95, df: 55, sa: 35, sd: 85, sp: 120 },
        weightkg: 27,
        abilities: { 0: 'Inner Focus' },
        baseSpecies: 'Sneasel',
        nfe: true
    ...
    Brambleshao: {
        ...
        bs: { hp: 60, at: 125, df: 65, sa: 90, sd: 65, sp: 109 },
        weightkg: 20.8,
        abilities: { 0: 'Storm Clinic' }
    },
    Eisephalon: {
        types: ['Ice', 'Fire'],
        bs: { hp: 67, at: 107, df: 83, sa: 113, sd: 89, sp: 79 },
        weightkg: 51,
    ...
    'Eisephalon-No Face': {
        types: ['Ice', 'Fire'],
        bs: { hp: 67, at: 107, df: 43, sa: 113, sd: 49, sp: 159 },
        weightkg: 51,
        abilities: { 0: 'Ultra Face' }
    },
    Frosgambit: {
        types: ['Ghost', 'Steel'],
        bs: { hp: 85, at: 110, df: 95, sa: 70, sd: 80, sp: 80 },
        weightkg: 73.3,
    ...
    Celeblim: {
        types: ['Flying'],
        bs: { hp: 127, at: 97, df: 73, sa: 101, sd: 79, sp: 71 },
        weightkg: 507.5,
    ...
    'Golegon-Alola': {
        types: ['Ground', 'Electric'],
        bs: { hp: 80, at: 120, df: 105, sa: 70, sd: 75, sp: 75 },
        weightkg: 199,
    ...
    Aerodirge: {
        types: ['Flying', 'Fire'],
        bs: { hp: 92, at: 95, df: 82, sa: 85, sd: 75, sp: 111 },
        weightkg: 192.8,
    ...
    'Aerodirge-Mega': {
        types: ['Flying', 'Fire'],
        bs: { hp: 92, at: 125, df: 102, sa: 95, sd: 95, sp: 131 },
        weightkg: 212.8,
        abilities: { 0: 'Tough Claws' },
    ...
    'Hydra-Pao': {
        types: ['Dragon', 'Ice'],
        bs: { hp: 93, at: 100, df: 95, sa: 105, sd: 72, sp: 89 },
        weightkg: 122.6,
    ...
    Hattepon: {
        ...
        otherFormes: [
            'Hattepon-Cornerstone', 'Hattepon-Cornerstone-Tera',
            'Hattepon-Hearthflame', 'Hattepon-Hearthflame-Tera',
            'Hattepon-Teal-Tera',
            'Hattepon-Wellspring', 'Hattepon-Wellspring-Tera',
        ],
        gender: 'F'
    },
    'Hattepon-Wellspring': {
    ...
    'Kilommo-o-Totem': {
        types: ['Electric', 'Dragon'],
        bs: { hp: 80, at: 90, df: 95, sa: 105, sd: 85, sp: 106 },
        weightkg: 123.1,
        abilities: { 0: 'Rogue' }
    },
    Lunarunt: {
    ...
    Bombirdus: {
        types: ['Flying', 'Dark'],
        bs: { hp: 75, at: 120, df: 77, sa: 92, sd: 85, sp: 101 },
        weightkg: 53,
