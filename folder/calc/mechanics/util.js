...
function checkIntimidate(gen, source, target) {
    var blocked = target.hasAbility('Clear Body', 'White Smoke', 'Hyper Cutter', 'Full Metal Body', 'Forest Fury', 'Vital Metal Body', 'No Nonsense') ||
...
function checkForestFury(gen, source, target) {
    var blocked = target.hasAbility('Clear Body', 'White Smoke', 'Hyper Cutter', 'Full Metal Body', 'Forest Fury', 'Vital Metal Body', 'No Nonsense') ||
        (gen.num >= 8 && target.hasAbility('Inner Focus', 'Own Tempo', 'Oblivious', 'Scrappy', 'Scrap Rock')) ||
        target.hasItem('Clear Amulet');
    if (source.hasAbility('Intimidate') && source.abilityOn && !blocked) {
...
exports.checkForestFury = checkForestFury;
function checkMadCow(gen, source, target) {
    var blocked = target.hasAbility('Clear Body', 'White Smoke', 'Hyper Cutter', 'Full Metal Body', 'Forest Fury', 'Vital Metal Body', 'No Nonsense') ||
        (gen.num >= 8 && target.hasAbility('Inner Focus', 'Own Tempo', 'Oblivious', 'Scrappy', 'Scrap Rock')) ||
        target.hasItem('Clear Amulet');
    if (source.hasAbility('Intimidate') && source.abilityOn && !blocked) {
...
exports.checkMadCow = checkMadCow;
function checkShockingFright(gen, source, target) {
    var blocked = target.hasAbility('Clear Body', 'White Smoke', 'Hyper Cutter', 'Full Metal Body', 'Forest Fury', 'Vital Metal Body', 'No Nonsense') ||
        (gen.num >= 8 && target.hasAbility('Inner Focus', 'Own Tempo', 'Oblivious', 'Scrappy', 'Scrap Rock')) ||
        target.hasItem('Clear Amulet');
    if (source.hasAbility('Intimidate') && source.abilityOn && !blocked) {
...
exports.checkShockingFright = checkShockingFright;
function checkDauntingStorm(gen, source, target) {
    var blocked = target.hasAbility('Clear Body', 'White Smoke', 'Hyper Cutter', 'Full Metal Body', 'Forest Fury', 'Vital Metal Body', 'No Nonsense') ||
        (gen.num >= 8 && target.hasAbility('Inner Focus', 'Own Tempo', 'Oblivious', 'Scrappy', 'Scrap Rock')) ||
        target.hasItem('Clear Amulet');
    if (source.hasAbility('Intimidate') && source.abilityOn && !blocked) {
...
exports.checkDauntingStorm = checkDauntingStorm;
function checkToxicAttitude(gen, source, target) {
    var blocked = target.hasAbility('Clear Body', 'White Smoke', 'Hyper Cutter', 'Full Metal Body', 'Forest Fury', 'Vital Metal Body', 'No Nonsense') ||
        (gen.num >= 8 && target.hasAbility('Inner Focus', 'Own Tempo', 'Oblivious', 'Scrappy', 'Scrap Rock')) ||
        target.hasItem('Clear Amulet');
    if (source.hasAbility('Intimidate') && source.abilityOn && !blocked) {
...
exports.checkToxicAttitude = checkToxicAttitude;
...
function checkSquall(source, attackingSide) {
    if (source.hasAbility('Squall') && attackingSide.isTailwind) {
        source.boosts.atk = Math.min(6, source.boosts.atk + 1);
    }
}
exports.checkSquall = checkSquall;
function checkStormClinic(source, attackingSide) {
    if (source.hasAbility('Storm Clinic') && attackingSide.isTailwind) {
        source.boosts.atk = Math.min(6, source.boosts.atk + 1);
    }
}
exports.checkStormClinic = checkStormClinic;
...
function checkOnceUponaTime(pokemon, affectedSide) {
    if (pokemon.hasAbility('Infiltrator')) {
        affectedSide.isReflect = false;
        affectedSide.isLightScreen = false;
        affectedSide.isAuroraVeil = false;
...
exports.checkOnceUponaTime = checkOnceUponaTime;
...
function isQPActive(pokemon, field) {
    ...
    var weather = field.weather || '';
    var terrain = field.terrain;
    return ((pokemon.hasAbility('Protosynthesis', 'Opening Act', 'Once Upon a Time', 'Primitive', 'Weight of Life', 'Ancient Marble', 'Prehistoric Hunter') &&
...
function getWeight(pokemon, desc, role) {
    ...
    var abilityFactor = pokemon.hasAbility('Heavy Metal', 'Weight of Life') ? 2
