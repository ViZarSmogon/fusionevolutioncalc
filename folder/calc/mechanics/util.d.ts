...
export declare function checkForestFury(gen: Generation, source: Pokemon, target: Pokemon): void;
export declare function checkMadCow(gen: Generation, source: Pokemon, target: Pokemon): void;
export declare function checkShockingFright(gen: Generation, source: Pokemon, target: Pokemon): void;
export declare function checkDauntingStorm(gen: Generation, source: Pokemon, target: Pokemon): void;
export declare function checkToxicAttitude(gen: Generation, source: Pokemon, target: Pokemon): void;
...
export declare function checkSquall(source: Pokemon, attackingSide: Side): void;
export declare function checkStormClinic(source: Pokemon, attackingSide: Side): void;
...
export declare function checkOnceUponaTime(pokemon: Pokemon, affectedSide: Side): void;
