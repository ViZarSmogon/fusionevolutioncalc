...
const SV_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  tadpi: {
    types: ['Electric', 'Fairy'],
    bs: {hp: 58, at: 25, df: 53, sa: 52, sd: 50, sp: 32},
    abilities: {0: 'Own Luck'},
    weightkg: 1,
  },
  shroowott: {
    types: ['Water', 'Poison'],
    bs: {hp: 67, at: 60, df: 40, sa: 51, sd: 40, sp: 60},
  ...
  charbebe: {
    gender: 'F',
    types: ['Fire', 'Fairy'],
    bs: {hp: 42, at: 45, df: 40, sa: 55, sd: 60, sp: 48},
    abilities: {0: 'Burning Petals'},
    weightkg: 8.2,
  },
  vanifu: {
    types: ['Ice', 'Fighting'],
    bs: {hp: 48, at: 70, df: 55, sa: 59, sd: 55, sp: 58},
    abilities: {0: 'Glacial Focus'},
    weightkg: 8.9,
  },
  larvix: {
    types: ['Rock', 'Ground'],
    bs: {hp: 42, at: 74, df: 105, sa: 37, sd: 47, sp: 55},
    abilities: {0: 'Sand Rush'},
    weightkg: 141,
  },
  goomud: {
    types: ['Water', 'Dragon'],
    bs: {hp: 50, at: 60, df: 45, sa: 60, sd: 65, sp: 40},
    abilities: {0: 'Wet Skin'},
    weightkg: 5.2,
  },
  marshgoohisui: {
    types: ['Water', 'Dragon'], 
    bs: {hp: 65, at: 80, df: 80, sa: 80, sd: 95, sp: 45},
    abilities: {0: 'Pondweed'},
    weightkg: 48.3,
  },
  frigiboolarge: {
    types: ['Dragon', 'Ghost'], 
    bs: {hp: 60, at: 70, df: 60, sa: 40, sd: 50, sp: 50},
    abilities: {0: 'Frisk Exchange'},
    weightkg: 12.3,
  },
  rowlax: {
    types: ['Normal', 'Flying'], 
    bs: {hp: 103, at: 70, df: 47, sa: 45, sd: 67, sp: 23},
    abilities: {0: 'Fat Fingers'},
    weightkg: 53.3,
  },
  dracoly: {
    types: ['Rock', 'Dragon'],  
    bs: {hp: 35, at: 55, df: 50, sa: 55, sd: 50, sp: 40},
    abilities: {0: 'Marvel Steam'},
    weightkg: 7.7,
  },
  dragocar: {
    types: ['Fire', 'Dragon'],
    bs: {hp: 70, at: 75, df: 80, sa: 75, sd: 70, sp: 60},
    abilities: {0: 'Marvel Steam'},
    weightkg: 47.3,
  },
  koffursa: {
    types: ['Normal', 'Poison'],
    bs: {hp: 70, at: 72, df: 72, sa: 55, sd: 67, sp: 37}, 
    abilities: {0: 'Honey Moon'}, 
    weightkg: 4.9,
  },
  timdough: {
    types: ['Fighting', 'Fairy'],
    bs: {hp: 56, at: 67, df: 62, sa: 27, sd: 45, sp: 50}, 
  ...
  ruffleplup: {
    gender: 'M',
    types: ['Water', 'Normal'],
    bs: {hp: 61, at: 67, df: 51, sa: 67, sd: 53, sp: 52}, 
    abilities: {0: 'Angry Bird'}, 
    weightkg: 7.9,
   },
   fishkarphisui: {
    types: ['Dark', 'Water'],
    bs: {hp: 42, at: 52, df: 70, sa: 35, sd: 37, sp: 102}, 
    abilities: {0: 'Fishy Threat'}, 
    weightkg: 6.9,
   },
  seeble: {
    types: ['Dragon', 'Grass'],
    bs: {hp: 49, at: 55, df: 47, sa: 55, sd: 37, sp: 36}, 
    abilities: {0: 'Sand Rush'}, 
    weightkg: 12.3,
   },
  nuzbite: {
    types: ['Dragon', 'Dark'],
    bs: {hp: 69, at: 80, df: 52, sa: 75, sd: 47, sp: 71}, 
    abilities: {0: 'Sand Rush'}, 
    weightkg: 42,
   },
  chimcharig: {
    types: ['Fire', 'Psychic'],
    bs: {hp: 65, at: 75, df: 55, sa: 75, sd: 55, sp: 75}, 
    abilities: {0: 'Fire Drinker'}, 
    weightkg: 23.8,
   },
  bramblefoo: {
    types: ['Fighting', 'Grass'],
    bs: {hp: 50, at: 75, df: 45, sa: 50, sd:45, sp: 65}, 
    abilities: {0: 'Storm Clinic'}, 
    weightkg: 10.3,
   },
   pawnrunt: {
    types: ['Steel', 'Ice'],
    bs: {hp: 50, at: 70, df: 60, sa: 45, sd: 45, sp: 55}, 
    abilities: {0: 'Inner Mood'}, 
    weightkg: 13.5,
   },
   kabeepy: {
    types: ['Water', 'Ghost'],
    bs: {hp: 35, at: 70, df: 60, sa: 47, sd: 45, sp: 70}, 
    abilities: {0: 'No Nonsense'}, 
    weightkg: 6.8,
   },
   tentather: {
    types: ['Flying', 'Poison'],
    bs: {hp: 55, at: 92, df: 60, sa: 52, sd: 90, sp: 87}, 
    abilities: {0: 'Hydrotechnic'}, 
    weightkg: 50.8,
   },
   geopinchalola: {
    types: ['Ground', 'Electric'],
    bs: {hp: 42, at: 110, df: 72, sa: 37, sd: 37, sp: 15}, 
    abilities: {0: 'Magnetic Force'}, 
    weightkg: 17.7,
   },
   vibraveleralola: {
    types: ['Ground', 'Electric'],
    bs: {hp: 52, at: 82, df: 82, sa: 52, sd: 52, sp: 52}, 
    abilities: {0: 'Magnetize'}, 
    weightkg: 62.7,
   },
   zorvanhahisui: {
    types: ['Ghost', 'Dark'],
    bs: {hp: 40, at: 75, df: 30, sa: 75, sd: 30, sp: 70}, 
    abilities: {0: 'Rough Image'}, 
    weightkg: 16.7,
   },
   starpede: {
    types: ['Poison', 'Flying'],
    bs: {hp: 35, at: 50, df: 45, sa: 30, sd: 35, sp: 60}, 
    abilities: {0: 'Quick Wit'}, 
    weightkg: 3.7,
   },
   whirlavia: {
    types: ['Poison', 'Flying'],
    bs: {hp: 50, at: 65, df: 75, sa: 40, sd: 60, sp: 65}, 
    abilities: {0: 'Toxic Attitude'}, 
    weightkg: 37,
   },
   watmoo: {
    types: ['Electric', 'Dragon'],
    bs: {hp: 45, at: 50, df: 50, sa: 50, sd: 45, sp: 66}, 
    abilities: {0: 'Rogue'}, 
    weightkg: 16.7,
   },
  spritkelp: {
    types: ['Fairy', 'Poison'],
    bs: {hp: 64, at: 56, df: 60, sa: 61, sd: 62, sp: 26}, 
    abilities: {0: 'Unstoppable'}, 
    weightkg: 3.9,
   },
   naclphish: {
    types: ['Water', 'Rock'],
    bs: {hp: 49, at: 80, df: 70, sa: 42, sd: 35, sp: 35}, 
    abilities: {0: 'Salted Lobster'}, 
    weightkg: 13.7,
   },
  */
